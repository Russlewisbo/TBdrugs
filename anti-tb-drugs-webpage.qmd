...
![Lesion microenvironments of *M. tuberculosis*, with drug penetration by compartment (PK) and activity by bacillary metabolic state (PD). Penetration and pharmacodynamic activity are orthogonal: pyrazinamide penetrates caseum yet fails at neutral pH, while rifampin uniquely combines lesion penetration with sterilizing activity. No current drug reliably kills fully dormant, non-metabolising bacilli.](anti-tb-drugs-images/revised_killing.png){#fig-populations fig-align="center" width="100%"}
...
| Near-dormant persisters in caseous necrotic foci | Rifampin (sterilizing), bedaquiline; pyrazinamide only at acid pH |
