...
: Mechanisms and molecular resistance determinants {#tbl-mechanisms}
...
: First-line agents at a glance {#tbl-firstline}
...
:::rifampin resistance implies cross-resistance to rifapentine (always) and usually rifabutin — though roughly a quarter of rifampin-resistant strains remain rifabutin-susceptible, a phenotype of uncertain clinical exploitability.
...
Rifampin inhibits the β-subunit of DNA-dependent RNA polymerase (human polymerase is insensitive). It is bactericidal against dividing organisms and — decisively — active against slow and near-dormant persisters, making it the sterilizing backbone that allowed six-month therapy (MIC 0.005–0.2 µg/mL; sputum conversion is roughly two weeks faster in rifampin-containing regimens). About 95% of resistance derives from point mutations in an 81-base-pair region of *rpoB*, rapidly detectable by molecular assay; rifampin resistance implies cross-resistance to rifapentine and usually rifabutin.
...
Dose- and duration-dependent retrobulbar (optic) neuritis presents as bilateral blurred vision, reduced acuity, and red–green colour vision loss (colour vision often changes first). Risk is higher at 25 mg/kg than 15 mg/kg and increases with renal impairment.rifampin from resistance when unrecognised isoniazid resistance is present; it is dropped once isoniazid and rifampin susceptibility are confirmed [@Belanger1996; @Alcaide1997].
...
: Dosing quick reference {#tbl-dosing}
...
: WHO drug groupings for individualized MDR/RR-TB regimens {#tbl-groups}
...
## A Brief Tour: Nontuberculous Mycobacterial Therapycompanion drugs (ethambutol and a rifamycin for MAC) protect the macrolide from resistance [@Daley2020ntm]. For MAC pulmonary disease the standard is macrolide + ethambutol + rifamycin, given three times weekly for nodular-bronchiectatic disease or daily for cavitary/severe disease.
